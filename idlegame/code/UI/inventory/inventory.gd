...
func update_color():
	...
	item2.add_theme_color_override("font_color", unselected_color)
	item3.add_theme_color_override("font_color", unselected_color)
	item4.add_theme_color_override("font_color", unselected_color)
	item5.add_theme_color_override("font_color", unselected_color)
	item6.add_theme_color_override("font_color", unselected_color)
	match you.get_selected():
		0:
			item.add_theme_color_override("font_color", selected_color)
		1:
			item2.add_theme_color_override("font_color", selected_color)
		2:
			item3.add_theme_color_override("font_color", selected_color)
		3:
			item4.add_theme_color_override("font_color", selected_color)
		4:
			item5.add_theme_color_override("font_color", selected_color)
		5:
			item6.add_theme_color_override("font_color", selected_color)
